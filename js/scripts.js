...
/***/
function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t}}var r=i(9),o=n(r),s=i(22),a=n(s),u=i(11),h=n(u),l=i(10),c=n(l),f=i(13),d=n(f),v=i(21),y=n(v),p=i(12),g=n(p),b=i(14),x=n(b),P=i(17),_=n(P),w=i(15),m=n(w),O=i(16),M=n(O),R=i(4),E=n(R),j=i(20),k=n(j),T=i(3),S=n(T),D=i(2),I=n(D),C=i(7),A=n(C),F=i(5),G=n(F),W=i(6),N=n(W),q={animate:o.default,rotate:a.default,canvas:h.default,bgSolid:c.default,line:d.default,segment:y.default,circle:g.default,rect:x.default,triangleR:_.default,triangleE:m.default,triangleI:M.default,classes:{Line:E.default,Segment:k.default,Circle:S.default,Rect:I.default,TriangleR:A.default,TriangleE:G.default,TriangleI:N.default}};t.exports=q},/* 9 */
/***/
...
function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t}}
// create new right-angled triangle, draw to the given context
function r(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:42,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:42,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:40,r=arguments.length>4&&void 0!==arguments[4]?arguments[4]:30;return new s.default(t,e,i,n,r)}Object.defineProperty(e,"__esModule",{value:!0}),e.default=r;var o=i(7),s=n(o)},/* 18 */
,/* 19 */
,/* 20 */
/***/
function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t}}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function o(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(e,"__esModule",{value:!0});var a=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}(),u=i(1),h=n(u),l=function(t){function e(t,i,n,s,a,u){r(this,e);var h=o(this,(e.__proto__||Object.getPrototypeOf(e)).call(this));return h.ctx=t,h.x=i,h.y=n,h.r=s,h.angle=a,h.chord=u,h.dir=!1,h.chord>2*h.r&&console.log({status:"ERROR",message:"mathematical problems - chord length (final argument), cannot exceed diameter (radius * 2). Consult docs for more information"}),h}/* ****
    DESIGN METHODS
  **** */
...
return s(e,t),a(e,[{key:"invert",value:function(){return this.dir=!this.dir,this}},{key:"draw",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"#FFC0CB",e=2*Math.asin(this.chord/(2*this.r));return this.ctx.beginPath(),this.ctx.arc(this.x+this.r,this.y,this.r,this.angle,this.angle+e,this.dir),this.ctx.fillStyle=t,this.ctx.fill(),this}},{key:"outline",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=t.weight,i=void 0===e?2:e,n=t.colour,r=void 0===n?"#808080":n,o=2*Math.asin(this.chord/(2*this.r));return this.ctx.beginPath(),this.ctx.arc(this.x+this.r,this.y,this.r,this.angle,this.angle+o,this.dir),this.ctx.lineWidth=i,this.ctx.strokeStyle=r,this.ctx.stroke(),this}}]),e}(h.default);e.default=l},/* 21 */
/***/
function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t}}function r(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:42,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:42,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:21,r=arguments.length>4&&void 0!==arguments[4]?arguments[4]:Math.PI,o=arguments.length>5&&void 0!==arguments[5]?arguments[5]:42;return new s.default(t,e,i,n,r,o)}Object.defineProperty(e,"__esModule",{value:!0}),e.default=r;var o=i(20),s=n(o)},/* 22 */
/***/
function(t,e,i){"use strict";function n(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=e.units,n=void 0===i?"rad":i,r=e.angle,o=void 0===r?Math.PI/2:r,s=e.code,a=void 0===s?function(){return console.log("rotated by: "+o)}:s,u=n.toUpperCase();return new Promise(function(e,i){"RAD"===u||"RADS"===u||"R"===u||"RADIANS"===u?(t.save(),t.rotate(o),a(),t.restore(),e("reset transformations")):"DEG"===u||"DEGS"===u||"D"===u||"DEGREES"===u?(t.save(),t.rotate(o*(Math.PI/180)),a(),t.restore(),e("reset transformations")):i({status:"ERROR",message:'units not recognised, please specify "deg" or "rad"'})})}Object.defineProperty(e,"__esModule",{value:!0}),e.default=n}]);
