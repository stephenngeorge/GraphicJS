...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var o=n(16),r=i(o),s=n(20),a=i(s),u=n(17),l=i(u),c=n(18),h=i(c),f=n(19),d=i(f),p=n(21),v=i(p),y=n(30),b=i(y),g=n(22),x=i(g),_=n(23),w=i(_),O=n(25),P=i(O),m=n(26),M=i(m),j=n(11),k=i(j),E=n(24),R=i(E),T=n(29),S=i(T),D=n(27),C=i(D),I=n(28),A=i(I),F=n(0),G=i(F),W=n(1),B=i(W),N=n(4),q=i(N),X=n(5),Y=i(X),U=n(6),z=i(U),H=n(7),V=i(H),L=n(3),J=i(L),K=n(2),Q=i(K),Z=n(10),$=i(Z),tt=n(8),et=i(tt),nt=n(9),it=i(nt),ot={animate:r.default,rotate:a.default,aside:l.default,map:d.default,canvas:h.default,bgSolid:v.default,vector:b.default,line:x.default,point:w.default,sector:P.default,segment:M.default,circle:k.default,rect:R.default,triangleR:S.default,triangleE:C.default,triangleI:A.default,classes:{Graphic:G.default,Vector:B.default,Line:q.default,Point:Y.default,Sector:z.default,Segment:V.default,Circle:J.default,Rect:Q.default,TriangleR:$.default,TriangleE:et.default,TriangleI:it.default}};t.exports=ot},/* 14 */
/***/
function(t,e,n){"use strict";function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});var o=function t(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"dynamic",o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"elastic";i(this,t),this.entity=e,this.type=n,this.collision=o};e.default=o},/* 15 */
/***/
function(t,e,n){"use strict";function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});var o=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=function(){function t(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o=n.gravity_x,r=void 0===o?0:o,s=n.gravity_y,a=void 0===s?1:s,u=n.context,l=void 0===u?null:u,c=n.boundX,h=void 0!==c&&c,f=n.boundY,d=void 0!==f&&f;i(this,t),this.bodies=e,this.gravity_x=r,this.gravity_y=a,this.context=l,this.boundX=h,this.boundY=d}return o(t,[{key:"applyForces",value:function(t){var e={x:this.gravity_x,y:this.gravity_y};return t.entity.pos.x+=e.x,t.entity.pos.y+=e.y,t}},{key:"restrictX",value:function(t){t.entity.pos.x>=this.context.canvas.clientWidth&&(t.entity.pos.x=this.context.canvas.clientWidth),t.entity.pos.x<=0&&(t.entity.pos.x=0)}},{key:"restrictY",value:function(t){t.entity.pos.y>=this.context.canvas.clientHeight&&(t.entity.pos.y=this.context.canvas.clientHeight),t.entity.pos.y<=0&&(t.entity.pos.y=0)}},{key:"step",value:function(){for(var t in this.bodies)this.boundX&&this.restrictX(this.bodies[t]),this.boundY&&this.restrictY(this.bodies[t]),this.applyForces(this.bodies[t]);return this}}]),t}();e.default=r},/* 16 */
/***/
function(t,e,n){"use strict";function i(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:24,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,i=0;return new Promise(function(o,r){var s=setInterval(function(){t(),i++,i===n&&(clearInterval(s),o(i)),18e5===i&&r({status:"ANIMATION STOPPED",message:"animation exceeded maximum length (30 mins), if you require a longer interval please consult the docs"})},1e3/e)})}Object.defineProperty(e,"__esModule",{value:!0}),e.default=i},/* 17 */
/***/
...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var o=n(13),r=i(o),s=n(12),a=r.default.canvas({id:"bouncing-balls",el:document.getElementById("canvas-container")}),u=a.c,l=a.width,c=a.height,h=(a.id,r.default.circle(u,.5*l,.5*c,20)),f=r.default.circle(u,.3*l,50,20),d={};d.ball=new s.Body(h),d.circ=new s.Body(f);var p=new s.Engine(d,{context:u,boundX:!0,boundY:!0});r.default.animate(function(){p.step(),r.default.bgSolid(u),h.draw().outline(),f.draw().outline()},96)}]);
