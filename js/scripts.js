...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var o=n(16),r=i(o),s=n(20),a=i(s),u=n(17),l=i(u),c=n(18),h=i(c),f=n(19),d=i(f),p=n(21),v=i(p),y=n(30),b=i(y),g=n(22),x=i(g),_=n(23),w=i(_),O=n(25),P=i(O),m=n(26),M=i(m),j=n(11),E=i(j),k=n(24),R=i(k),T=n(29),S=i(T),D=n(27),C=i(D),I=n(28),A=i(I),F=n(0),G=i(F),W=n(1),B=i(W),N=n(4),q=i(N),U=n(5),z=i(U),H=n(6),V=i(H),L=n(7),X=i(L),Y=n(3),J=i(Y),K=n(2),Q=i(K),Z=n(10),$=i(Z),tt=n(8),et=i(tt),nt=n(9),it=i(nt),ot={animate:r.default,rotate:a.default,aside:l.default,map:d.default,canvas:h.default,bgSolid:v.default,vector:b.default,line:x.default,point:w.default,sector:P.default,segment:M.default,circle:E.default,rect:R.default,triangleR:S.default,triangleE:C.default,triangleI:A.default,classes:{Graphic:G.default,Vector:B.default,Line:q.default,Point:z.default,Sector:V.default,Segment:X.default,Circle:J.default,Rect:Q.default,TriangleR:$.default,TriangleE:et.default,TriangleI:it.default}};t.exports=ot},/* 14 */
/***/
...
/***/
function(t,e,n){"use strict";function i(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0});var o=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),r=function(){function t(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o=n.gravity_x,r=void 0===o?0:o,s=n.gravity_y,a=void 0===s?1:s;i(this,t),this.bodies=e,this.gravity_x=r,this.gravity_y=a}return o(t,[{key:"applyForces",value:function(t){var e={x:this.gravity_x,y:this.gravity_y};return t.entity.pos.x+=e.x,t.entity.pos.y+=e.y,t}},{key:"update",value:function(){for(var t in this.bodies)this.applyForces(this.bodies[t]);return this}}]),t}();e.default=r},/* 16 */
/***/
...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var o=n(13),r=i(o),s=n(12),a=r.default.canvas({id:"bouncing-balls",el:document.getElementById("canvas-container")}),u=a.c,l=a.width,c=a.height,h=(a.id,r.default.circle(u,.5*l,.5*c)),f={};f.ball=new s.Body(h);var d=new s.Engine(f);r.default.animate(function(){r.default.bgSolid(u),h.draw(),d.update()},24,100)}]);
