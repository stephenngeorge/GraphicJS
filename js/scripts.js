...
/***/
function(t,e,n){"use strict";function i(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"#e7e7e7",n=t.canvas.clientWidth,i=t.canvas.clientHeight;t.fillStyle=e,t.fillRect(0,0,n,i)}
// draw fill rectangle full size of canvas, colour default to light grey
Object.defineProperty(e,"__esModule",{value:!0}),e.default=i},/* 6 */
/***/
...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var r=n(4),o=i(r),s=document.getElementById("canvas"),u=s.getContext("2d");s.width,s.height;o.default.bgSolid(u)},/* 11 */
/***/
