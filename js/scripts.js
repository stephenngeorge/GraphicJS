...
return r(t,[{key:"draw",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"#FFC0CB";return this.ctx.fillStyle=t,this.ctx.fillRect(this.x,this.y,this.width,this.height),this}},{key:"outline",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=t.weight,i=void 0===e?2:e,n=t.colour,r=void 0===n?"#808080":n;return this.ctx.lineWidth=i,this.ctx.strokeStyle=r,this.ctx.strokeRect(this.x-i/2,this.y-i/2,this.width+i,this.height+i),this}},{key:"area",value:function(){return this.width*this.height}},{key:"perim",value:function(){return 2*(this.width+this.height)}}]),t}();e.default=o},/* 3 */
/***/
...
/***/
function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t}}var r=i(5),o=n(r),s=i(7),u=n(s),h=i(6),a=n(h),l=i(8),c=n(l),f=i(9),d=n(f),v=i(1),y=n(v),g=i(0),x=n(g),b=i(2),p=n(b),P=i(3),w=n(P),M={bgSolid:o.default,line:u.default,circle:a.default,rect:c.default,triangleR:d.default,classes:{Line:y.default,Circle:x.default,Rect:p.default,TriangleR:w.default}};t.exports=M},/* 5 */
/***/
...
/***/
function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t}}var r=i(4),o=n(r),s=document.getElementById("canvas"),u=s.getContext("2d");s.width,s.height;o.default.bgSolid(s);o.default.line(u,150,20,32,50).draw({weight:2,colour:"black"})}]);
