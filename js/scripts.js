...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var r=n(4),o=i(r),s=document.getElementById("canvas"),u=s.getContext("2d");s.width,s.height;o.default.bgSolid(u).cartesian(),o.default.circle(u,0,0,70).outline(),o.default.line(u,0,0,0,70).draw({weight:2,colour:"#555"})},/* 11 */
/***/
