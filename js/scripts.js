...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function o(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(e,"__esModule",{value:!0});var a=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),u=n(0),c=i(u),h=function(t){function e(t,n,i,s){r(this,e);var a=o(this,(e.__proto__||Object.getPrototypeOf(e)).call(this));return a.ctx=t,a.x=n,a.y=i,a.r=s,a}/* ****
    DESIGN METHODS
  **** */
...
/***/
function(t,e,n){"use strict";function i(t){return t&&t.__esModule?t:{default:t}}var r=n(8),o=i(r),s=n(10),a=i(s),u=n(9),c=i(u),h=n(12),l=i(h),f=n(11),d=i(f),v=n(13),y=i(v),p=n(15),b=i(p),g=n(14),x=i(g),_=n(3),P=i(_),w=n(2),O=i(w),m=n(1),M=i(m),j=n(5),k=i(j),E=n(4),R=i(E),T={animate:o.default,canvas:a.default,bgSolid:c.default,line:l.default,circle:d.default,rect:y.default,triangleR:b.default,triangleE:x.default,classes:{Line:P.default,Circle:O.default,Rect:M.default,TriangleR:k.default,TriangleE:R.default}};t.exports=T},/* 7 */
/***/
...
outlines:{weight:3,colour:"RebeccaPurple"}};t.exports=i},/* 8 */
/***/
function(t,e,n){"use strict";function i(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:24,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,i=0,r=setInterval(function(){t(),i++,i===n&&clearInterval(r)},1e3/e)}Object.defineProperty(e,"__esModule",{value:!0}),e.default=i},/* 9 */
/***/
...
function r(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"#e7e7e7",n=t.canvas.clientWidth,i=t.canvas.clientHeight,r=new s.default(t,0,0,n,i).draw(e);return r}Object.defineProperty(e,"__esModule",{value:!0}),e.default=r;var o=n(1),s=i(o)},/* 10 */
/***/
...
var r=n(6),o=i(r),s=(n(7),o.default.canvas({id:"graphicJS-tutorial-sketch",el:document.getElementById("canvas-container")})),a=s.c,u=s.width,c=s.height,h=(s.id,0),l=0,f=[];o.default.bgSolid(a,"#fff").centre(),o.default.animate(function(){o.default.rect(a,.5*-u,.5*-c,u,c).draw("#e7e7e7"),f.forEach(function(t){o.default.circle(a,t.x,t.y,3).draw("rgba(200, 0, 100, .05)")});var t=o.default.circle(a,h,l,6).draw("rgba(200, 0, 100, .8)");f.push({x:t.x,y:t.y});
// if (history.length > 50) { history.shift() }
var e=Math.random();e<=.25?h++:e<=.5?l++:e<=.75?h--:e<=1&&l--},24,240)}]);
