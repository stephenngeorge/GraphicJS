...
n.d(e,"a",function(){return y});/* harmony import */
var f=n(2),y=/*#__PURE__*/
function(t){function e(){var t;return r(this,e),t=c(this,u(e).call(this)),t.static=!1,t}return h(e,t),s(e,[{key:"move",value:function(){return this.vel=this.vel.add(this.acc),this.pos=this.pos.add(this.vel),this.acc.mult(0),this}},{key:"applyForce",value:function(t){return!1===this.static?(this.acc=this.acc.add(t),this):(console.log("shape is static, cannot apply force"),this)}}]),e}(f.a)},/* 2 */
/***/
...
var o=n(20),r=o.a.backgrounds,i=o.a.globals,s=o.a.helpers,c=o.a.shapes,a=o.a.structure,u=a.canvas({id:"canvas"}),h=u.c,l=u.width,f=u.height;r.bgsolid(h);// define empty array
var y=[],p=i.vector(0,.1),v=i.vector(.04,0);// on click, draw ball at mouse position, set acceleration & add to balls array
document.getElementById("canvas").addEventListener("click",function(t){var e=i.mouse(h)._pos(t),n=s._random(8,12),o=c.circle(h,e.x,e.y,n);y.push(o)}),a.animate(function(){r.bgsolid(h),y.forEach(function(t){
// draw ball
t.draw().outline(),// is ball is not 'static', animate it
!1===t.static&&(
// gravity is altered according to ball radius to simulate different mass
t.applyForce(i.vector(p.x,t.r/5*p.y)),t.applyForce(i.vector(t.r/5*v.x,v.y)),// set new position vector based on force -> acc -> vel -> pos
t.move(),// prevent ball from going beyond the bounds of the canvas
