...
n.d(e,"a",function(){return y});/* harmony import */
var f=n(2),y=/*#__PURE__*/
function(t){function e(){return i(this,e),c(this,u(e).apply(this,arguments))}return h(e,t),s(e,[{key:"move",value:function(){return this.vel=this.acc,this.pos=this.pos.add(this.vel),this}}]),e}(f.a)},/* 2 */
/***/
...
e.a=y},/* 21 */
/***/
function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0});for(var o=n(20),i=o.a.backgrounds,r=o.a.globals,s=o.a.helpers,c=o.a.shapes,a=o.a.structure,u=a.canvas({width:window.innerWidth,height:window.innerHeight,id:"canvas"}),h=u.c,l=u.width,f=u.height,y=[],p=0;p<20;p++){var v=Math.ceil(Math.random()*l),b=Math.ceil(Math.random()*f),d=Math.ceil(30*Math.random());y.push(c.circle(h,v,b,d))}document.getElementById("canvas").addEventListener("mousemove",function(t){var e=r.mouse(h)._pos(t),n=r.vector(e.x,e.y);y.forEach(function(t){t.acc=n.copy().sub(t.pos).mult(1/t.r)})}),a.animate(function(){i.bgsolid(h,"#fff"),y.forEach(function(t){t.move().draw("rgba(200, 0, ".concat(s._map(t.r,1,16,0,255),", .5)")).outline().wrapX(0,l).wrapY(0,f)})},10)},/* 22 */
/***/
