...
var o=n(20),i=o.a.backgrounds,r=o.a.globals,s=(o.a.helpers,o.a.shapes),c=o.a.structure,a=c.canvas({id:"canvas"}),u=a.c,h=(a.width,a.height);i.bgsolid(u);var l=[];document.getElementById("canvas").addEventListener("click",function(t){var e=r.mouse(u)._pos(t),n=s.circle(u,e.x,e.y,8);n.acc=r.vector(0,1),l.push(n)}),c.animate(function(){i.bgsolid(u),l.forEach(function(t){t.move(),t.draw(),t.boundY(0,h)})})},/* 22 */
/***/
