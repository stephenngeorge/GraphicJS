...
var o=n(17),i=o.a.backgrounds,r=o.a.globals,s=(o.a.helpers,o.a.shapes),u=o.a.structure,c=u.canvas({width:400,height:400,id:"canvas"}),a=c.c,h=c.width,l=c.height,f=s.circle(a,h/2,l/2,8),p=null;document.getElementById("canvas").addEventListener("mousemove",function(t){var e=r.mouse(a)._pos(t);p=r.vector(e.x,e.y),f.acc=p.sub(f.pos).mult(.1)}),u.animate(function(){i.bgsolid(a),f.move().draw().outline().wrapX(0,h).wrapY(0,l)},10)},/* 19 */
/***/
